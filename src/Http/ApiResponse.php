...
namespace essa\APIGenerator\Http;
...
trait ApiResponse
{
     ...
     * @return JsonResponse
     */
    private function APIError(int $code, $title = 'Oops . Something went wrong , try again or contact the support', $details = null): JsonResponse
    {
     ...
     * @return JsonResponse
     */
    public function responseUnAuthorized($details = 'you are not authorized to preform this actions', $message = 'Unauthorized!'): JsonResponse
    {
     ...
     * @return JsonResponse
     */
    public function responseUnAuthenticated($details = 'you are not authenticated to preform this actions', $message = 'unauthenticated!'): JsonResponse
    {
     ...
     * @return JsonResponse
     */
    public function responseConflictError($details = 'conflict', $message = 'conflict!'): JsonResponse
    {
     ...
     * @return JsonResponse
     */
    public function responseCreated($message = 'Record created successfully', $data = null): JsonResponse
    {
        return response()->json(
            [
                "message" => $message,
